...
module.exports.createNewPost = async (req, res, next) => {
    console.log("creating new post iside middle ware");
    ...
    await post.save();
    console.log(post);
    req.flash('success', 'Successfully made a new posts!');
    res.redirect(`/posts/${post._id}`)
}

//show sing post or details of post
module.exports.showPost = async (req, res,) => {
    console.log("inside show single post");
